...
<div style="font-size: 14px; text-align: right;">
    <div style="display: inline-block; text-align: left; width: 60%;">※増加差分 = （BのCVR - AのCVR）×（A+Bの総訪問者数）</div><br>
    <div style="display: inline-block; text-align: left; width: 60%;">※月間換算 = 増加差分 ÷ テスト日数 × 30日</div>
</div>
""", unsafe_allow_html=True)
