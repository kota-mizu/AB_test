...
st.markdown(fr'''
  <p style="text-align: center; font-size: 20px;">Bを採用することで <span style="color: {color}; font-size: {font_size}; font-weight: bold;">{"{:.1%}".format(prob)}</span>の確率でCVRは平均的に向上することが期待されます。</p>
  ''', unsafe_allow_html=True)
